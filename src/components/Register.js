...
class Register extends Component {
    constructor(){
        super();
        this.changeEmail = event => this.props.onChangeEmail(event.taget.value);
        this.changePassword = event => this.props.onChangePassword(event.target.value);
        this.changeUsername = event => this.props.onChangeUsername(event.target.vaule);
        ...
        return(
            <div className="auth-page">
                ...
                <div className="col-md-6 offset-md-3 col-xs-12">
                    ...
                    <ListError errors={this.props.erros} />
